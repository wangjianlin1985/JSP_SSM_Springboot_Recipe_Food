...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>消息id</td><td>消息内容</td><td>发送人</td><td>接收人</td><td>发送时间</td><td>阅读状态</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=messageInfo.getReciever().getName() %></td>
 											...
 											<td>
 												...
 												<a href="#" onclick="messageInfoDelete('<%=messageInfo.getMessageId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="messageInfoQueryForm" id="messageInfoQueryForm" action="<%=basePath %>MessageInfo/frontlist" class="mar_t15" method="post">
