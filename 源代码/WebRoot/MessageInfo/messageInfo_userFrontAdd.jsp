				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="messageInfoAdd"> 
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxMessageInfoAdd();" class="btn btn-primary bottom5 top5">发送</span>
				          </div>
						</form> 
...
var basePath = "<%=basePath%>";
	...
	function ajaxMessageInfoAdd() { 
		...
		jQuery.ajax({
			type : "post",
			url : basePath + "MessageInfo/userAdd",
			dataType : "json" , 
...
$(function(){
	...
	$.ajax({
		...
		success: function(userInfos,response,status) { 
			...
			$("#messageInfo_reciever_user_name").val("<%=request.getParameter("reciever") %>");
    	}
	});
	//发送时间组件
