		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="userInfo_jifen" class="col-md-2 text-right">用户积分:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_jifen" name="userInfo.jifen" value="0" class="form-control" placeholder="请输入用户积分">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
