			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		用户积分:<%=userInfo.getJifen() %>
			     	</div>
			     	<div class="field" style="display:none;">
	            		注册时间:<%=userInfo.getRegTime() %>
			     	</div>
			        <a class="btn btn-primary top5" href="<%=basePath %>UserInfo/<%=userInfo.getUser_name() %>/frontshow">详情</a>
			        <a class="btn btn-primary top5" href="<%=basePath %>MessageInfo/messageInfo_userFrontAdd.jsp?reciever=<%=userInfo.getUser_name() %>">发消息</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_jifen_edit" class="col-md-3 text-right">用户积分:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_jifen_edit" name="userInfo.jifen" class="form-control" placeholder="请输入用户积分">
			 </div>
		  </div>
		  <div class="form-group">
